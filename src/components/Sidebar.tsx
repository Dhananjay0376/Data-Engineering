...
import { Database, RefreshCw, Download, GitBranch, HardDrive, Workflow, ChevronRight, BookOpen, Menu, X, Layers, GitMerge, CheckCircle2, Activity, Shield } from 'lucide-react';
import { topics } from '../lib/data';

const iconMap: Record<string, React.ComponentType<any>> = {
  Database, RefreshCw, Download, GitBranch, HardDrive, Workflow, Layers, GitMerge, CheckCircle2, Activity, Shield
};
          ...
          {[1, 2].map((sessionNumber) => (
            <div key={sessionNumber} className="space-y-2">
              ...
              <div className="space-y-1">
                {topics
                  .filter((t) => t.session === sessionNumber)
                  .map((topic) => {
